...
// FIX: Added Record<string, any> to the generic constraint to provide an index signature for T.
// This resolves the TypeScript error related to indexing and ensures the accessed property is assignable to ReactNode.
