import { User, Task, CalendarEvent, Product, Review, BlogPost, Conversation, Message } from './types';
...
export const USERS_DATA: User[] = [
  { id: 1, name: 'Admin User', email: 'admin@example.com', role: 'Admin', status: 'active', lastLogin: '2024-07-21 10:00 AM', bio: 'Administrator with full access.' },
